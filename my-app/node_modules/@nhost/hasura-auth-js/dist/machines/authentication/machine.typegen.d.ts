export interface Typegen0 {
    ...
    eventsCausingActions: {
        ...
        destroyRefreshToken: 'SESSION_UPDATE' | 'SIGNIN_ANONYMOUS' | 'SIGNIN_MFA_TOTP' | 'SIGNIN_PASSWORD' | 'SIGNIN_PAT' | 'SIGNIN_SECURITY_KEY_EMAIL' | 'done.invoke.signingOut' | 'error.platform.signingOut' | 'xstate.stop';
        ...
        resetErrors: '' | 'PASSWORDLESS_EMAIL' | 'PASSWORDLESS_SMS' | 'PASSWORDLESS_SMS_OTP' | 'SESSION_UPDATE' | 'SIGNIN_ANONYMOUS' | 'SIGNIN_MFA_TOTP' | 'SIGNIN_PASSWORD' | 'SIGNIN_PAT' | 'SIGNIN_SECURITY_KEY_EMAIL' | 'SIGNUP_EMAIL_PASSWORD' | 'SIGNUP_SECURITY_KEY' | 'done.invoke.authenticateAnonymously' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.authenticateUserWithSecurityKey' | 'done.invoke.authenticateWithPAT' | 'done.invoke.authenticateWithToken' | 'done.invoke.importRefreshToken' | 'done.invoke.passwordlessSmsOtp' | 'done.invoke.signInMfaTotp' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey';
